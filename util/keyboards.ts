...
export const reportKeyboard = new InlineKeyboard()
    .text('🔞 Материал для взрослых', '0').row()
    .text('💰 Продажа товаров и услуг', '1').row()
    .text('💩 Не нравится', '2').row()
    .text('🦨 Другое', '3').row()
    .text('Назад', 'back')

export const reportCheckKeyboard = new InlineKeyboard()
    .text('Бан', 'reportBan').row()
    .text('Пропустить', 'reportContinue').row()
